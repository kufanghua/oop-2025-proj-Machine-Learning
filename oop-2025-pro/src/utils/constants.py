...
class ProjectileType(Enum):
    ...
    MACHINE_BULLET = "machine_bullet"
    FREEZE_SHOT = "freeze_shot"
# 你可以根據遊戲實際需求調整名稱
...
MAP_SETTINGS = {
    "path": [(100, 300), (250, 300), (400, 150), (600, 400), (800, 300)],  # 路徑座標點
    "bg_color": (48, 85, 54),  # 地圖背景顏色
    "path_color": (220, 220, 100),  # 路徑線顏色
    "path_width": 8,  # 路徑線寬
    # 你可以根據需求再加：塔可放點、地圖大小、障礙物等
}
...
# 你可以根據遊戲設計調整內容
WAVE_SETTINGS = [
    {"enemy_type": "BASIC", "count": 10, "interval": 1.0},
    {"enemy_type": "FAST", "count": 15, "interval": 0.8},
    {"enemy_type": "TANK", "count": 5, "interval": 2.0},
]
TILE_SIZE = 40
...
GAME_SETTINGS = {
    ...
    "initial_lives": 20,
    "initial_money": 100,
    "PLAYER_HEALTH": 20,  # ← 加這行
    "INITIAL_MONEY": 100,  # 加這行
    "TILE_SIZE": TILE_SIZE,
    # 你可以根據實際需求增加其他設定
}
