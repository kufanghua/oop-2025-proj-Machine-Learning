...
from ..utils.constants import WAVE_SETTINGS
...
class WaveManager:
    ...
    def __init__(self):
        ...
        # 自動開始設定
        self.auto_start_waves = WAVE_SETTINGS.get('AUTO_START', True)
        self.wave_clear_bonus = WAVE_SETTINGS.get('WAVE_CLEAR_BONUS', 50)
    ...
    def _generate_waves(self) -> None:
        """生成所有波數數據"""
        # 預設生成30波
        total_waves = WAVE_SETTINGS.get('TOTAL_WAVES', 30)
